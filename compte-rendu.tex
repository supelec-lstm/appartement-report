...
\State Initialiser un tableau $dejaCalculé$ de longueur $|V|$ à $faux$.
\For{$i \in V_{out}$}
	\State Calculer $\frac{\partial E}{\par	tial y_i}$
	\State $déjàCalculé_i \leftarrow vrai$ 
\EndFor
\For{$i \in V$}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[scale=0.25]{images/xor_tanh_centre.png} & \includegraphics[scale=0.25]{images/xor_relu_centre.png} \\
\includegraphics[scale=0.25]{images/cout_xor_tanh_centre.png} & \includegraphics[scale=0.25]{images/cout_xor_relu_centre.png}
\end{tabular}
