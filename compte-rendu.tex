...
\begin{center}
\begin{tabular}{cc}
\includegraphics[scale=0.5]{images/xor_tanh_centre.png} & \includegraphics[scale=0.5]{images/xor_relu_centre.png} \\
\includegraphics[scale=0.5]{images/cout_xor_tanh_centre.png} & \includegraphics[scale=0.5]{images/cout_xor_relu_centre.png}
\end{tabular}
...
Nous travaillions jusque là avec des réseaux récurrents comme celui présenté sur la figure suivante composé d'une simple couche de tangentes hyperboliques.

\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.3]{images/RNN_classique.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.3]{images/cellule_LSTM_article.png}
\caption{Cellule élémentaire des LSTM}
\label{cellule LSTM}
\end{center}
\end{figure}

% préciser légende du diagramme
% préciser différentes parties de la cellule
% diagramme avec cellules à la suite
% expliquer les différentes parties de la cellule

% explication + formules rétropropagation 
