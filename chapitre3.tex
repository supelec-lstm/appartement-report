...
\hline
\begin{center}\input{images/chapter3/nodes/node_softmax.tex}\end{center} & \begin{center}$softmax(x)$\end{center} & \begin{center}$\left(\sum_{k = 1}^{n}{y_{i,j}(\delta_{j,k} - y_{i,k})\frac{\partial E}{\partial y_{i, k}}}\right)_{i,j}$\end{center} \\ 
\hline
...
\hline
\begin{center}\input{images/chapter3/nodes/node_add_bias.tex}\end{center} & \begin{center}$1|x = \begin{pmatrix}1 & x\end{pmatrix}$\end{center} & \begin{center}$(\frac{\partial E}{\partial y}_{i, j})_{i \in \{2, ..., m+1\}, j \in \{1, ..., n\}}$\end{center} \\ 
\hline
\end{tabular}
\end{center}
...
\hline
\begin{center}\input{images/chapter3/nodes/node_concatenation.tex}\end{center} & \begin{center}$x_1|x_2 = \begin{pmatrix}x_1 & x_2\end{pmatrix}$\end{center} & \begin{center}$ $\end{center} \\
\hline
\begin{center}\input{images/chapter3/nodes/node_sigmoid_cross_entropy.tex}\end{center} & \begin{center}$sigmoidCE(x_1, x_2)$\end{center} & \begin{center}$ $\end{center} \\
\hline
\begin{center}\input{images/chapter3/nodes/node_softmax_cross_entropy.tex}\end{center} & \begin{center}$softmaxCE(x_1, x_2)$\end{center} & \begin{center}$ $\end{center} \\
\hline
\end{tabular}
\end{center}
